...
- sintaxe do Delphi 13, com variáveis inline, inferência de tipo e strings multilinha;
- código explícito: sem `with`, sem receptores ocultos e sem abreviações que prejudiquem
  a compreensão;
