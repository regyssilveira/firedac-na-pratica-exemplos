...
O projeto executa seis contratos independentes:
...
- `contract`: prepara uma consulta, valida tipo e direção do parâmetro e comprova a
  detecção de uma divergência deliberada.
